...
| Zone group | Main mandatory content |
|---|---|
...
Spawn-A/B receive faction T1/T2 dwellings. Center-A copies Spawn-A's faction biome for T5/T6 dwellings, and Center-B copies Spawn-B's. Weekly growth is disabled for every tier. The initial increment of `1` grants one starting batch of creatures when the dwelling is generated; it does not add another batch each week.
