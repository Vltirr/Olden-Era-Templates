...
Pandora's Box, Arborcopia, Village, Eternal Dragon, Four Scholars Shrine, and Pit of Glory are limited to `0` throughout the template. The Golden Goose Egg artifact is globally banned. Spawn zones additionally exclude weekly resource storage sites and Stables; Gingerbread House is prohibited in Spawn and Center.
...
Every Spawn zone guarantees one tier 2 resource bank matching its biome, plus one additional random bank chosen from Iridescent Abbey, Uncanny Rite, and Circle of Life. For example, a Grass or Dirt Spawn is guaranteed an Iridescent Abbey and can contain at most two Iridescent Abbeys; every other biome can contain at most one. The other pairs are Deathland/Snow - Uncanny Rite and Autumn/Lava - Circle of Life.
