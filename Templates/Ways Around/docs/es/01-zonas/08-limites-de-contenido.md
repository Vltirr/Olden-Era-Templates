...
Caja de Pandora, Arborcopia, Aldea, Dragón eterno, Sagrario de los cuatro eruditos y Foso de la gloria tienen límite `0` en toda la plantilla. El artefacto Huevo de oca de oro está baneado globalmente. Las zonas Spawn excluyen además los depósitos semanales de recursos y los Establos; la Casa de galleta de jengibre está prohibida en Spawn y Center.
...
Cada zona Spawn garantiza un banco de recursos T2 adecuado a su bioma y, además, otro aleatorio entre Abadía Iridiscente, Rito insólito y Ciclo de la vida. Por ejemplo, una zona Spawn de Grass o Dirt garantiza una Abadía Iridiscente y puede contener como máximo dos Abadías Iridiscentes; cualquier otro bioma solo puede contener una. Las otras asociaciones son Deathland/Snow - Rito insólito y Autumn/Lava - Ciclo de la vida.
